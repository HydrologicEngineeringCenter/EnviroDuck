 ...
 *
 * This class provides a java components that allows the Month and Day to safely and easily be 
 * selected using 2 drop down menus.
 */
public class DateInput extends javax.swing.JPanel {
    ...
    /** set the day displayed to d. If d int not a valid day as determined by the current month
     *  it is ignored */
    ...
    /** array of month abrevations */
    String[] months = {"Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"};
    
    /** array of legal day as strings */
